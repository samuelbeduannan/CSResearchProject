...
data = pd.read_csv('C:/Users/sam_bedu-annan/OneDrive - TransCanada Corporation/Desktop/CSResearchProject/Feature_selection_methods_with_sample_datasets/SVM_Sample/data1.csv')
...
sns.violinplot(x="features", y="value", hue="sample_class", data=data, split=True, inner="quart")
